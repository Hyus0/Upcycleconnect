    ...
    <div class="page-container">
        <header class="content-header">
            <div class="header-left">
                <p class="sidebar__category2">ACCUEIL > TIPS > CRÉER</p>
                <h1 class="hero-title1">DÉPOSER UN TIP</h1>
                <p class="classic-text">
                    Partagez une astuce utile avec la communauté.
                </p>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        if (response.ok) {
            successMsg.value = "Tip publié avec succès !";
            setTimeout(() => {
